...
void Create_SED(TString dat1="1ES0229_mwl_data.dat",TString dat2="1ES0229_mwl_data_hystorical.dat",TString dat3="0229_model_SL_correct_units_Fab.dat",TString dat4="0229_model_correct_units_Asano.dat",TString dat50="0229_model_ss_correct_units_Matteo.dat", TString dat51="0229_model_pss_ebl_correct_units_Matteo.dat",TString dat52="0229_model_neu3_correct_units_Matteo.dat")
{
    ...
    TCanvas *c1 = new TCanvas("c1","SED",650,500);
    c1->SetFillColor(10);
    //c1->SetBorderMode(0);
    //c1->SetBorderSize(1);
...
//     //    leg->AddEntry(gr2,"Archival data", "ep");
//     leg->AddEntry(gr4,"SSC model", "l");
//     leg->AddEntry(gr3,"Spine-layer model", "l");
//     leg->AddEntry(gr50,"Lepto-hadronic model", "l");
//     //   leg->AddEntry(gr51,"LeptoHad model - Proton Synchro", "l");
//     // leg->AddEntry(gr52,"LeptoHad model - Neutrinos", "l");
//    //    leg->Draw();

 //    TLatexNDC t(0.5,0.5,"1ES 0229+200");  
//     //    t.SetNDC(kTRUE);
//     t.Draw();
 ...
 TText *t1 = new TText(1e27,2e-11,"1ES 0229+200");
 //t1->SetTextAlign(22);
