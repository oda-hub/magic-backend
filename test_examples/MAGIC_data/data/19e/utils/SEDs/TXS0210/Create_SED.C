...
void Create_SED(TString dat1="TXS0210_mwl_data.dat",TString dat2="TXS0210_mwl_data_hystorical.dat",TString dat3="0210_model_SL_correct_units_Fab.dat",TString dat4="0210_model_correct_units_Asano.dat",TString dat50="0210_model_ss_correct_units_Matteo.dat", TString dat51="0210_model_pss_ebl_correct_units_Matteo.dat",TString dat52="0210_model_neu3_correct_units_Matteo.dat")
{
...
//File dat1 should contain the modeled broad-band SED data with the following format: id ,freq, freq_lower_err, freq_upper_err, flux, flux_lower_err, flux_upper_err
 ...
 //File dat5 should contain a modelling curve of the broad-band SED data with the following format: freq, flux,
  ...
  //File dat5 should contain a modelling curve of the broad-band SED data with the following format: freq, flux,
    ...
    leg->AddEntry(gr3,"SSC - Spine-layer model", "l");
